		    	...
		    	<div class="row">
		    		...
		    		<div class="col-footer col-md-4">
		    			...
		    			<p class="contact-us-details">
	        				<b>Address:</b> Jl. Kampung Melayu Jatinegara, Jakarta - Indonesia<br/>
	        				<b>Phone:</b>+62 812-1224-9809<br/>
	        				<b>Email:</b> <a href="mailto:support@rumahpiknik.com">support@bahanpiknik.com</a>
	        			</p>
		    		</div>
		    		<div class="col-footer col-md-4">
		    			<h3 class="text-warning" >Our Social Networks</h3>
        ...
        <script src="bootstrap/js/bootstrap.min.js"></script>
				...
				<script>(function(d, s, id) {
				  ...
				  js.src = "//connect.facebook.net/id_ID/sdk.js#xfbml=1&version=v2.5&appId=361799390664986";
