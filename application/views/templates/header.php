...
<head>
	...
	<link rel="stylesheet" href="bootstrap/css/bahanpiknik.css">
    ...
    <!--easy-ticer -->
    <link rel="stylesheet" href="bootstrap/css/bjqs.css">
    <script type="text/javascript" src="bootstrap/js/jquery.easing.min.js"></script>
		<script type="text/javascript" src="bootstrap/js/jquery.easy-ticker.js"></script>
